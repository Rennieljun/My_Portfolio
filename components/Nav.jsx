...
const Nav = () => {
  ...
  return (
    ...
    <div className="fixed md:hidden flex flex-col justify-start place-items-end gap-4 right-0 top-20 bottom-[50%] left-[50%] z-10 pointer-events-none">
        ...
        <div className={`item block w-[80%] rounded-l-2xl z-11 bg-[#1c86ba] shadow-md shadow-black ${toggleDropdown == false ? 'translate-x-80' : 'translate-x-0' } ease-in-out duration-500`}>
          <Link href='/projects'>
