        ...
        <div className='flex justify-center items-center w-full'>
             <div className='w-fit overflow-hidden'>
                ...
                className='md:text-lg text-sm md:text-left text-center text-slate-500'>
                    <span className='md:text-lg text-sm text-slate-300 font-bold'>Hello, </span> I am Renniel. My goal is to be a software developer to gain experience and develop my skills and knowledge. Example of that are the programming languages, tools, framework I used in building this portfolio which is the <span className='text-cyan-600'>Next.js</span>  a new framework of <span className='text-cyan-600'>React.js.</span>I am still exploring its functionality. Moreover, I used <span className='text-cyan-600'>Tailwind css</span> for the styling of this portfolio, <span className='text-cyan-600'>Framer Motion</span>  for the animation, and I used <span className='text-orange-700'>firebase</span> to store some info. lastly a NodeMailer so you can send me a message.
                </motion.h2>
            </div>
        </div>
    </div>
